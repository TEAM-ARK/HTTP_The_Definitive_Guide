...
**📌참고 - [루프백](https://www.techopedia.com/definition/25794/loopback-test)이란?**
...
📌**참고 - [Prefetching](https://blog.daum.net/wetsand/64)**
...
📌**참고 - 각 메서드의 캐시, 안전함, 멱등성, HTML 양식에서 사용 가능 여부**
...
<p style="color: green">100 Continue</p>
...
<p style="color: green">303 See Other</p>

- 클라이언트에게 리소스를 다른 URL에서 가져와야 한다고 말해주고자 할 때 쓰임.

<p style="color: green">304 Not Modified</p>
...
<p style="color: green">307 Temporary Redirect</p>
...
<p style="color: green">400 Bad Request</p>
...
<p style="color: green">401 Unauthorized</p>
...
<p style="color: green">403 Forbidden</p>

- 요청이 서버에 의해 거부됨.

<p style="color: green">404 Not Found</p>
...
<p style="color: green">405 Method Not Allowed</p>
...
<p style="color: green">500 Internal Server Error</p>

- 서버가 요청을 처리할 수 없게 만드는 에러를 만났을 때 사용

<p style="color: green">502 Bad Gateway</p>
...
<p style="color: green">503 Service Unavaliable</p>
...
<p style="color: green">504 Gateway Timeout</p>
...
책에 작성된 HTTP 메서드 명세는 [1999년에 작성된 글의 기준](https://www.rfc-editor.org/rfc/rfc2616#page-56)으로 작성된 것 같습니다. [2014년에 작성된 HTTP 명세](https://datatracker.ietf.org/doc/html/rfc7231#section-4.3.5)에서 일부 추가된 내용이 있으니 확인바랍니다.
...
[요청 헤더(MDN문서)](https://developer.mozilla.org/ko/docs/Glossary/Request_header)
더 추가할 예정